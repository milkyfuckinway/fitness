...
/* harmony import */ var _vendor_ytdefer__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./vendor/ytdefer */ "./js/vendor/ytdefer.js");
...
/* harmony import */ var _sliders_crew_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./sliders/crew.js */ "./js/sliders/crew.js");
/* harmony import */ var _sliders_reviews_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./sliders/reviews.js */ "./js/sliders/reviews.js");
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  window.addEventListener('load', function () {
    ...
    Object(_vendor_ytdefer__WEBPACK_IMPORTED_MODULE_2__["ytdeferInit"])();
  });
});
  ...
  fetch(url, {
    ...
    if (response.ok) {
      ...
      entries.forEach(function (entry) {
        ...
        p.textContent = "".concat(entry[0], ": ").concat(entry[1]);
        modal.appendChild(p);
      });
...
/*!****************************!*\
  !*** ./js/sliders/crew.js ***!
  \****************************/
/*! exports provided: crewSwiper */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "crewSwiper", function() { return crewSwiper; });
var crew = document.querySelector('.crew');
var crewSwiperContainer = crew.querySelector('.swiper');
var nextButton = crew.querySelector('.swiper-button--next');
var prevButton = crew.querySelector('.swiper-button--prev');
var crewSwiper = new Swiper(crewSwiperContainer, {
...
var reviewsSwiperContainer = reviews.querySelector('.swiper');
var nextButton = reviews.querySelector('.swiper-button--next');
var prevButton = reviews.querySelector('.swiper-button--prev');
var reviewsSwiper = new Swiper(reviewsSwiperContainer, {
  direction: 'horizontal',
  loop: false,
  navigation: {
    nextEl: nextButton,
...
/***/ "./js/vendor/ytdefer.js":
/*!******************************!*\
  !*** ./js/vendor/ytdefer.js ***!
  \******************************/
/*! exports provided: ytdeferInit */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "ytdeferInit", function() { return ytdeferInit; });
function ytdeferSetup() {
  var ytdeferElements = document.querySelectorAll('.ytdefer');
  ytdeferElements.forEach(function (ytdeferElement, index) {
    var divElement = createDivElement(index);
    ytdeferElement.appendChild(divElement);
    var buttonElement = createButtonElement(index);
...
function createDivElement(index) {
  ...
  divElement.id = "ytdefer_vid".concat(index);
  divElement.style.position = 'relative';
  return divElement;
}
function createButtonElement(index) {
  var buttonElement = document.createElement('button');
  buttonElement.id = "ytdefer_icon".concat(index);
...
var genYtdeferClk = function genYtdeferClk(index) {
  return function () {
    var videoDivElement = document.querySelector("#ytdefer_vid".concat(index));
    var videoId = videoDivElement.parentNode.getAttribute('data-src');
    var player = new YT.Player(videoDivElement.id, {
      videoId: videoId,
      playerVars: {
        'autoplay': 1,
        'playsinline': 1
...
var ytdeferInit = function ytdeferInit() {
  ytdeferSetup();
};
