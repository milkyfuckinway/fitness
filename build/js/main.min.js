...
/* harmony import */ var _modules_video_video_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./modules/video/video.js */ "./js/modules/video/video.js");
/* harmony import */ var _modules_video_video_js__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(_modules_video_video_js__WEBPACK_IMPORTED_MODULE_2__);
...
var playButton = videoContainer.querySelector('[data-preview-button]');
var previewImage = videoContainer.querySelector('img');
var video = videoContainer.querySelector('iframe');
var videoLink = videoContainer.getAttribute('data-src');
videoContainer.addEventListener('click', function (evt) {
