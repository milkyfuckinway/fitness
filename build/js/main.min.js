...
/* harmony import */ var _modules_video_init_video__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./modules/video/init-video */ "./js/modules/video/init-video.js");
...
/* harmony import */ var _sliders_crew__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./sliders/crew */ "./js/sliders/crew.js");
/* harmony import */ var _sliders_reviews__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./sliders/reviews */ "./js/sliders/reviews.js");
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  window.addEventListener('load', function () {
    ...
    Object(_modules_video_init_video__WEBPACK_IMPORTED_MODULE_2__["initVideo"])();
    Object(_sliders_crew__WEBPACK_IMPORTED_MODULE_4__["initCrewSwiper"])();
    Object(_sliders_reviews__WEBPACK_IMPORTED_MODULE_5__["initReviewsSwiper"])();
  });
});
...
var videoContainer = document.querySelectorAll('.video');
var initVideo = function initVideo() {
  if (videoContainer.length > 0) {
    videoContainer.forEach(function (item) {
      var preview = item.querySelector('.video__preview');
      var button = item.querySelector('.video__button');
      button.tabIndex = '0';
      var iframe = item.querySelector('iframe');
      iframe.tabIndex = '-1';
      var playVideo = function playVideo() {
        var originalSrc = item.getAttribute('data-src');
        iframe.src = "".concat(originalSrc, "?autoplay=1&mute=1");
...
/*!****************************!*\
  !*** ./js/sliders/crew.js ***!
  \****************************/
/*! exports provided: initCrewSwiper */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "initCrewSwiper", function() { return initCrewSwiper; });
...
var initCrewSwiper = function initCrewSwiper() {
  if (crew) {
    ...
    crewSwiper.init();
    var crewSlides = Array.from(crew.querySelector('.swiper-wrapper').children);
    var setTabIndex = function setTabIndex() {
      crewSlides.forEach(function (item) {
...
/*!*******************************!*\
  !*** ./js/sliders/reviews.js ***!
  \*******************************/
/*! exports provided: initReviewsSwiper */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
